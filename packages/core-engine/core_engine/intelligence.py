...
from .decision_coach_preview import (
    ...
    humanize_specialization_reason as _humanize_specialization_reason,
    ...
    resolve_authoritative_coaching_recommendation_rationale as _resolve_authoritative_coaching_recommendation_rationale,
)
...
def build_profile_upsert_persistence_payload(
    *,
    ...
    choose_for_me_family: str | None,
    choose_for_me_diagnostics: dict[str, Any] | None,
    ...
    return {
        ...
        "program_selection_mode": program_selection_mode or "manual",
        "choose_for_me_family": choose_for_me_family,
        "choose_for_me_diagnostics": deepcopy(choose_for_me_diagnostics) if isinstance(choose_for_me_diagnostics, dict) else {},
...
humanize_specialization_reason = _humanize_specialization_reason
resolve_coaching_recommendation_rationale = _resolve_authoritative_coaching_recommendation_rationale
